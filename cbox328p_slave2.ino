...
void loop()
{
    ...
    if(onboard::btnChanged())
    {
        if(onboard::getBtn())
        {
            timer::set(255,255,255);
        }
        else
        {
...
void command()
{
    ...
    if(c == CONF_CMD_DIRECT)
    {
        ...
        bool over = rs::buffer[4] == '1';

        onboard::manual_override = over;
        onboard::update();
    }

    else if(c == CONF_CMD_SYNC) {
        // !7<ID>#

        onboard::setLedsU(0, 1, 1);
        ...
        Serial.print(";");
        Serial.print(APPLICABLE_IDS[1]);
        Serial.print(";");
        Serial.print(APPLICABLE_IDS[2]);
        Serial.print(";");
        Serial.print(APPLICABLE_IDS[3]);
        Serial.print("$");
        Serial.flush();
